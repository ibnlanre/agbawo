...
export declare function update(object: object, path: Path, callbackFn: (value: any) => any): object;
...
export declare function forEach(object: object, callbackFn: callback): void;
export declare function map(object: object, callbackFn: callback): object;
